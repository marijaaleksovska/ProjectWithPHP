			...
			<div class="fh5co-main-nav">
				<div class="container-fluid">
					...
					<div class="fh5co-logo">
						<a href="index.html"> <img src="images/logo.png"  width="110px" height="90px"></a>
					</div>
					<div class="fh5co-menu-2">
						<a href="#" data-nav-section="events">Ресторани</a>
						<a href="#" data-nav-section="reservation">Резервирај</a>
						<a href="#" data-nav-section="najavise" >Најави се</a>
				...
				<div class="row">
					...
					<div class="col-md-6 to-animate-2">
						...
						<div class="form-group">
							...
							<input id="date" class="form-control" placeholder="Датум &amp; Време" type="text">
						</div>

						<div class="form-group">
							<label for="number" class="sr-only">Број на луѓе</label>
							<input type="number" min="1" max="40" id="number" class="form-control" placeholder="Број на луѓе" >
						</div>
  ...
  document.getElementById('divMayus').style.visibility = 'hidden';
		...
		<div id="fh5co-menus" data-section="najavise" style="background-color: #DBDADA; background-size: cover">
			...
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
					<div class="col-md-8 col-md-offset-2">
						<h2 class="heading to-animate">Најави се</h2>
						<center> <p class="sub-heading to-animate"> 
						<form method="POST" action="login.php"><div class="form-group " style="width: 70%;">
							
							<input id="username1" name="username1" class="form-control" placeholder="Корисничко име" type="text" required>
						</div>
							<div class="form-group " style="width: 70%">
							<input id="lozinka" name="lozinka" class="form-control" placeholder="Лозинка" type="password"  onkeypress="capLock(event)"required>
								<a style="float:right; padding-right: 10px; cursor: pointer; font-size: 14px" onclick="document.getElementById('id02').style.display='block'" >Ја заборавивте лозинката?</a>
							<div id="divMayus" style="visibility:hidden; color:#fb6e14">Вклучено е Caps Lock .</div> 
								
								<?php echo "<center><p id='error'> $error </p> </center>";
						...
						<div class="form-group " style="width: 70%">
							...
							<input class="btn btn-primary"  value="Најави се" name="login_user" type="submit" style="float: right;"> 
							<a style="float:right; padding-right: 10px; cursor: pointer" onclick="document.getElementById('id01').style.display='block'" >Регистрирај се</a>
  ...
  <form class="m-content" action="server.php" method="POST">
    ...
    <div class="c">
     ...
     <!-- <label for="email"><b>Презиме</b></label>
      ...
      <input  class="i"type="password" placeholder="Внеси лозинка" name="pass" required minlength="6">
      ...
      <div class="clearfix">
        ...
        <button type="submit" name="register" class="signupbtn">Регистрирај се</button>
      </div>
    </div>
  </form>
</div>
...
<!-- Modal za zaboravi, lozinka -->
			
			<div id="id02" class="m">
  <span onclick="document.getElementById('id02').style.display='none'" class="close9" title="Close Modal">&times;</span>
  <form class="m-content" action="nova_lozinka.php" method="POST">
	  
    <div class="c">
      <h1 style="color:darkorange"><b></b>Ja заборавивте лозинката</h1></b>
	   <hr>
      <p>Внесете го вашето корисничко име:</p>
	  
     
      <input class="i" type="text" placeholder="Корисничко име" name="zaboravi" id="zaboravi" required>
      <div class="clearfix">
		   
        <button type="button" onclick="document.getElementById('id02').style.display='none'" class="cancelbtn">Откажи</button>
        <button type="submit" name="register" class="signupbtn">Ресетирај лозинка</button>
		  <small>Проверете го својот е-маил за ресетирање на лозинката.</small>
      </div>
    </div>
  </form>
</div>
